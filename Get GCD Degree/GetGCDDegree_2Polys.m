function t = GetGCDDegree_2Polys(fx, gx, k_limits)
% GetGCDDegree(fx,gx)
%
...
switch SETTINGS.METRIC
    ...
    case 'Singular Values'
        ...
        plotSingularValues(arr_SingularValues);
        plotMinimumSingularValues(vMinimumSingularValues);
    ...
    case 'Residuals'
        ...
        plotMinimumResiduals(vMinimumResidual, k_limits);
    ...
    case 'R1 Row Diagonals'
        ...
        plotRowDiagonals(arr_DiagonalsR1, k_limits)
    ...
    case 'R1 Row Norms'
        ...
        plotRowNorms(arr_R1_RowNorms, k_limits);
        plotMaxMinRowSum(vMaxRowNormR1, vMinRowNormR1, k_limits);
...
if (upperLimit == lowerLimit ) % If only one Subresultant Exists
    ...
    [t] = GetGCDDegree_MultipleSubresultants(metric, my_limits);
